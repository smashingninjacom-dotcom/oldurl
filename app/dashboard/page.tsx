            ...
            {totalPages > 1 && (
              <div className="px-5 py-4 bg-white border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-4">
                <div className="text-xs text-gray-500 font-medium">
                  ...
                  <span className="font-bold text-[#0d1b3e]">{Math.min(currentPage * pageSize, sortedSearches.length)}</span> of{' '}
                  <span className="font-bold text-[#0d1b3e]">{sortedSearches.length}</span> domains
                </div>
