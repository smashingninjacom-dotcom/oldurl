...
export default function DomainMarketplaceInventoryPage() {
  ...
  return (
    <div className="space-y-6 max-w-[1400px] w-full mx-auto pb-16 font-sans">
      ...
      {/* DIRECT POP-STYLE SCREENSHOT LIGHTBOX MODAL */}
      {selectedDomainForLinks && (() => {
        ...
        const isRevealed = isAdmin || revealedDomainIds.has(selectedDomainForLinks.id);
            ...
            >
              ...
              <div className="p-4 md:p-5 flex items-center justify-between gap-4 border-b border-gray-100 bg-white z-10 shrink-0">
                <div>
                  <div className="flex items-center gap-2 flex-wrap">
                    <h2 className="text-xl md:text-2xl font-black text-gray-900 tracking-tight uppercase font-mono">
                      {isRevealed ? selectedDomainForLinks.domain : maskDomainName(selectedDomainForLinks.domain)}
                    </h2>
                    {!isRevealed && (
                      <button
                        type="button"
                ...
                <div className="flex items-center gap-2">
                  ...
                  {isAdmin && (
                    <label className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white hover:bg-orange-50 text-[#FC6B17] border border-orange-200 rounded-xl font-bold text-xs cursor-pointer transition-colors shadow-2xs">
              ...
              <div className="p-3 md:p-6 bg-slate-900/95 overflow-y-auto flex items-center justify-center min-h-[320px] max-h-[65vh]">
                <div className="w-full relative group rounded-xl overflow-hidden border border-slate-700 shadow-2xl bg-black">
                  ...
                  {isAdmin && selectedDomainForLinks.screenshots && selectedDomainForLinks.screenshots.length > 0 && (
                    <button
                      type="button"
                      onClick={(e) => {
                        e.stopPropagation();
                        handleRemoveScreenshotInLinksModal(0);
                      }}
